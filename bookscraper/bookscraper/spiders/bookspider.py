...
import scrapy
from ..items import BookItem  # Make sure this is the correct import
import random
...
class BookspiderSpider(scrapy.Spider):
   ...
   #this will overwrite what you have in settings.py
    custom_settings = {
        'FEEDS' : {
    ...
    def parse_book_page(self, response):
        ...
        book_item['category'] = response.xpath('//ul[@class="breadcrumb"]/li[position()=last()-1]/a/text()').get()
